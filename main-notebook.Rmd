...
```{r}
rating_matrix <- rating_matrix[nrow(rating_matrix) > 50, ncol(rating_matrix) > 100]
```

Vediamo diversi modi per addestrare il sistema di raccomandazione:
```{r}
split_matrix <- evaluationScheme(rating_matrix, method="split", train=0.8, given=15, goodRating=3, k=3)
